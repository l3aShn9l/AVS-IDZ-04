...
void *Watering(void *param) {
    ...
    while (true) {
        ...
        if (FadingFlowers.size() > 0) {
            ...
            std::cout << "time = " << clock() << " | Gardener #" << MyNum << " watered flower #" << MyFlower + 1
                      << "\n";
        } else {
...
int main(int argc, char *argv[]) {
    ...
    pthread_create(&GardenerThread1, NULL, Watering, (void *) (num + 1));
    pthread_create(&GardenerThread2, NULL, Watering, (void *) (num + 2));
    //Вызов
    Fading(NULL);
